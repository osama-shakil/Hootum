...
export default function FilterSection2() {
  ...
  return (
    <div className="flex flex-col space-y-6 p-4 md:flex-row md:items-center md:justify-between  md:space-y-0">
      ...
      <div className="flex flex-col space-y-1 md:w-[300px]">
  <div className="flex items-center justify-between">
    <label className="text-sm font-medium">Price range</label>
    <span className="text-sm font-medium bg-black px-2 py-1 rounded-3xl text-white">{priceRange[0].toLocaleString()} BDT</span>
  </div>
  <Slider
    value={priceRange}
    max={100000}
