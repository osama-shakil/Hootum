			...
			<div className='border-y md:border border-[#D3D3D3] md:px-4 pb-4 rounded-[5px] space-y-4'>
				...
				<div className='flex items-center justify-between border-bottom border-b'>
					<div className='flex space-x-2 items-center'>
						...
						<div>
							<p className='text-sm font-normal flex'>Artist</p>
				...
				<div className='space-y-2'>
					...
					<div className='flex items-center space-x-2'>
						<input
							type='text'
							className='border rounded-md p-2 w-full text-[18px] font-bold outline-none'
						...
						<select
							...
							className='border rounded-md p-2 text-sm font-medium'
						>
							<option>BDT</option>
							<option>USD</option>
							<option>EUR</option>
